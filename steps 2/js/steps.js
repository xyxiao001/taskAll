...
(function(a, b) {
  a.widget("bootstrap.bwizard", {
    options: {
      clickableSteps: true, // 能否点击上面菜单切换
      autoPlay: false,
      delay: 3000,
      loop: false,
      hideOption: {
    ...
    _showPanel: function(f) {
      ...
      if ((g.showOption.blind || g.showOption.fade) && g.showOption.duration > 0) {
        ...
        e.hide().removeClass("hide").animate(d, g.showOption.duration || "normal",
        function() {
          c._resetStyle(e);
    ...
    show: function(f) {
      ...
      h = this.options,
      e = a.extend({},
      this._ui(this.panels[h.activeIndex])),
      c,
      g;
      e.nextIndex = f;
